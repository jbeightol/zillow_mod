...
class Links(SourceData):
    ...
    def set_data(self, source_data):
        ...
        try:
            ...
            ## this is for the updated property details
            self.home_details = source_data['homeDetails']
            self.home_info = source_data['homeInfo']
        try:
...
class ExtendedData(SourceData):
    ...
    def set_data(self, source_data):
        ...
        self.usecode = source_data.get('useCode')
    ...
    # def set_data2(self, source_data):
    #     self.fips_county = source_data.get('FIPScounty', None)
    #     self.usecode = source_data.get('useCode')
    #     self.tax_assessment_year = source_data.get('taxAssessmentYear', None)
    #     self.tax_assessment = source_data.get('taxAssessment', None)
...
class Place(SourceData):
    ...
    def set_data2(self, source_data):
        """
        :source_data": Data from data.get('UpdatedPropertyDetails:updatedPropertyDetails', None)['response']
        :param source_data:
        :return:
        """
        ...
        self.links.set_data(source_data['links'])
        self.full_address.set_data(source_data['address'])
        self.school_district = source_data.get('schoolDistrict')
        self.high_school = source_data.get('highSchool')
        self.middle_school = source_data.get('middleSchool')
        self.elementary_school = source_data.get('elementarySchool')
        if self.has_extended_data:
            self.extended_data.set_data(source_data.get('editedFacts'))
